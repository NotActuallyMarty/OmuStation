...
public abstract class SharedOniWeaponProficiencySystem : EntitySystem // remember to make client dumbass
{
    ...
    private void OnExamineOther(Entity<OniWeaponProficiencyComponent> user, EntityUid examinedEnt)
    {
